...
class SimpleReviewManager {
  static final InAppReview _inAppReview = InAppReview.instance;
  
  /// Call this method after successful complaint submission
  /// This automatically works for both iOS App Store and Google Play Store
  static Future<void> requestReview({
    ...
    try {
      ...
      if (isAvailable) {
        // Request in-app review (works on both iOS and Android)
        await _inAppReview.requestReview();
        print('In-app review requested successfully');
      } else {
        ...
        print('Store listing opened as fallback');
      }
    } catch (e) {
      print('Error requesting review: $e');
      // If everything fails, silently continue - don't disrupt user experience
    }
  }
}